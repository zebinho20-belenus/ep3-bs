(function() {
    ...
    $(document).ready(function() {
        ...
        /* Badge popovers — click on notification badge opens booking summary */

        document.querySelectorAll('.notification-badge[data-popover-content]').forEach(function(badge) {
            var popover = new bootstrap.Popover(badge, {
                html: true,
                content: badge.getAttribute('data-popover-content'),
                trigger: 'focus',
                placement: 'bottom',
                container: 'body'
            });
