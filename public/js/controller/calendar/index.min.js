        ...
        $(".calendar-date-col").each(function(dateIndex) {
            ...
            for (var i = 0; i < eventGroups.length; i++) {
                ...
                $.each(cellsByCol, function(colIndex, cells) {
                    ...
                    console.log("[overlay-debug] col:", colIndex, "posFirst:", posFirst, "posLast:", posLast, "firstCell tag:", firstCell.prop("tagName"), "outerWidth:", firstCell.outerWidth(), "outerHeight:", lastCell.outerHeight());
                    ...
                    if (posFirst && posLast) {
                        ...
                        console.log("[overlay-debug] creating overlay:", overlayId, "x:", startX, "y:", startY, "w:", eventWidth, "h:", eventHeight);
                        ...
                        if (! eventGroupOverlay.length) {
                            ...
                            console.log("[overlay-debug] appended overlay to wrapper, now in DOM:", $("#" + overlayId).length);
                        }
                    ...
                    } catch(e) { console.error("[overlay-debug] ERROR:", e); }
                });
            }
        });
    }
